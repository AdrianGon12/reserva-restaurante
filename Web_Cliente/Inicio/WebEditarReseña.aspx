<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebEditarReseña.aspx.cs" Inherits="Web_Cliente.Inicio.WebEditarReseña" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="drivers-area bg-img" style="background-image: url(https://cafe.museolarco.org/wp-content/uploads/2018/03/restaurant.jpg)">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <asp:Button class="btn btn-buscar" ID="btnEditarReseña" runat="server" Text="Actualizar" style="margin-bottom: 100px;" OnClick="btnEditarReseña_Click" />
                        </div>
